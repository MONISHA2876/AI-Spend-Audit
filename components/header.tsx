  ...
  return (
    <header className="sticky top-0 z-50 w-full h-17.5 bg-gray-900">
      <div className="container flex justify-between items-center px-6 py-4 text-gray-500">
        ...
        <Link href="/contact">
          <button className="px-4 py-2 rounded-xl bg-white/10 border border-white/10 text-sm font-medium text-gray-200 backdrop-blur-md hover:bg-yellow-500/40 hover:text-white transition-all duration-300 shadow-lg">
            Get In Touch
          </button>
        </Link>
      </div>
